...
namespace UI
{
    public class PlayersValuesUI : MonoBehaviour
    {
        ...
        {
            Game.CurrentPlayer.healthChanged.RemoveListener(OnEnemyHealthChange);
            Game.CurrentPlayer.forceChanged.RemoveListener(OnEnemyForceChange);
            Game.Enemy.healthChanged.RemoveListener(OnPlayerHealthChange);
            Game.Enemy.forceChanged.RemoveListener(OnPlayerForceChange);
            
            Game.CurrentPlayer.healthChanged.AddListener(OnPlayerHealthChange);
            Game.CurrentPlayer.forceChanged.AddListener(OnPlayerForceChange);
            Game.Enemy.healthChanged.AddListener(OnEnemyHealthChange);
